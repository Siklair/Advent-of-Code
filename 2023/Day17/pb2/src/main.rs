...
const MIN_SAME_DIRECTION: usize = 4;
const MAX_SAME_DIRECTION: usize = 10;
...
impl State {
    ...
    fn neighbours(&self, rows: usize, cols: usize, map: &HashMap<Position, usize>) -> Vec<(Self, usize)> {
        ...
        // /!\ this duplicated code should be factorized
        // dir2 neighbours
