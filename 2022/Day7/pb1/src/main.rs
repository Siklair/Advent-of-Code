...
fn main() {
    ...
    fn add_to_res(dir: &Directory, files: &HashMap<PathBuf, AFile>, directories: &HashMap<PathBuf, Directory>, res: &mut u32) -> u32 {
        let mut size = 0;
    ...
    add_to_res(directories.get(&PathBuf::from("/")).unwrap(), &files, &directories, &mut res);
